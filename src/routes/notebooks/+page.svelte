<script lang="ts">
  ...
  const products = [
    ...
    // R$2.690,00
    {
      title: "Nº4 - (NT0048)NOTEBOOK LENOVO THINKPAD T490",
      image: ".png",
    ...
    // R$2.690,00
    {
      title: "Nº5 - (NT0064)NOTEBOOK LENOVO IDEAPAD ",
      image: "NT0064.png",
