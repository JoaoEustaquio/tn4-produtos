<script lang="ts">
  ...
  const products = [
    ...
    // R$1.490,00
    {
      title: "Nº1 - (NT00) THINKPAD T440S",
      image: "THINKPAD-T440S.png",
    ...
    // R$3.390,00
    {
      title: "Nº5 - (NT0068)NOTEBOOK THINKPAD E490",
