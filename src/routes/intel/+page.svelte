<script lang="ts">
  ...
  const products = [
    ...
    // R$1.790,00
    {
      title: "Nº2 - (PC0016)i5 3ª + RX 550 - R$1.890,00",
      image: "PC0016.png",
    ...
    // R$2.190,00
    {
      title: "Nº3 - (PC0020)i7 de 3ª + RX 550  - R$2.190,00",
      image: "N3-Intel.png",
    ...
    // R$4.990,00
    {
      title: "Nº7 - i3 de 13ª + RTX 3050 6GB",
      image: "N4-INTEL.png",
    ...
    // R$8.890,00
    {
      title: "(PC0006)Nº8 - i5 de 12ª + RTX 4060 8GB ",
      image: "PC0006.png",
