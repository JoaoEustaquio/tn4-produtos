<script lang="ts">
    ...
    const gpus = [
        { title: "GT 730 2GB", price: "R$ 450,00" },
        { title: "GT 1030 2GB", price: "R$ 790,00" },
        { title: "RX 550 4GB", price: "R$ 890,00" },
        { title: "GTX 1650 4GB", price: "R$ 1.290,00" },
        { title: "RX 580 8GB", price: "R$ 1.190,00" },
        { title: "RTX 3050 8GB", price: "R$ 2.190,00" },
