<script lang="ts">
  ...
  const products = [
    ...
    // R$ 10.690,00 Restore
    {
      title: "Nº11 - (PC0067) SETUP INTEL I5-12400F(12º Geração), RTX 4060 8GB,GABINETE GAMER 'AQUARIO' + MONITOR DE 30' E KIT GAMER PRO",
      image: "PC0067.png",
